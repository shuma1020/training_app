...
user2 = User.create!(id: 2, email: "user2@example.com", password: "password", name: "gggg", role: :normal)
user3 = User.create!(id: 3, email: "user３@example.com", password: "password", name: "user3", role: :staff)
