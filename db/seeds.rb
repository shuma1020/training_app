...
User.create!(id: 2, email:　"gggg@gmail.com", password:　"gggggs", name: "gggg")
Product.create!(title: "aaa", price: 100, description:　"3333", message: "gggg", user_id: 1)
Product.create!(title: "ddd", price: 100, description:　"3333", message: "sasas", user_id: 1)
Product.create!(title: "eeee", price: 100, description:　"eeee", message: "eeee", user_id: 2)
Product.create!(title: "eeee", price: 100, description:　"eeee", status =:release, message: "eeee", user_id: 2)
Product.create!(title: "eeee", price: 100, description:　"eeee", status =:draft, message: "eeee", user_id: 2)
Product.create!(title: "eeee", price: 100, description:　"eeee", status =:release, message: "eeee", user_id: 2)
